...
<table id="high-rated-POI" title="POIs" class="easyui-datagrid" style="width:1200px;height:500px;"
    ...
    <tr>
        ...
        <th field="average" width="12">average score</th>
    </tr>
    </thead>
</table>
...
<script>
    $('#high-rated-POI').datagrid({
        view: detailview,
        url: "<%=request.getContextPath()%>/POIAction/getHighRatedPOI.jsp",
        ...
        onExpandRow: function(index,row){
            ...
            ddv.panel({
                ...
                onLoad:function(){
                    $('#high-rated-POI').datagrid('fixDetailRowHeight', index);
                    $('#high-rated-POI').datagrid('selectRow', index);
                }
            });
            $('#high-rated-POI').datagrid('fixDetailRowHeight',index);
        }
