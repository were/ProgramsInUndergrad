...
//cout << "3: " << MINIBASE_BM->descriptor.size() << endl;

    fp->num_db_pages = num_pages;

//cout << "3' " << endl;

//cout << "4: " << MINIBASE_BM->descriptor.size() << endl;

    init_dir_page( &fp->dir, sizeof *fp );

//cout << "5: " << MINIBASE_BM->descriptor.size() << endl;
...
//cout << "1: " << MINIBASE_BM->descriptor.size() << endl;

    num_pages = fp->num_db_pages;

//cout << "2: " << MINIBASE_BM->descriptor.size() << endl;
