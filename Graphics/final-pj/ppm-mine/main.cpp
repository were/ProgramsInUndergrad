...
Sphere spheres[] = {//Scene: radius, position, emission, color, material 
	Sphere(12,  Vec(-15, 12 ,-38),      Vec(),Vec(1,1,1)*.99, SPEC),//Mirr 
	Sphere(6,  Vec(5, 23, -44),      Vec(),Vec(1,1,1)*.99, DIFF),//Mirr 
	Sphere(12,  Vec(21, 12, -38),      Vec(),Vec(1,1,1)*.99, REFR),//Mirr 
...
//	model.load_from_obj("models/bunny.fine.obj");
	model.load_from_obj("models/empty.obj");
